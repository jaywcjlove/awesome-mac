...
* [CueTap](https://github.com/CheyYuAn/CueTap) - 미리 준비한 텍스트를 키 입력마다 한 글자씩 재생. 라이브 데모와 스크린캐스트에서 오타 방지. [![Open-Source Software][OSS Icon]](https://github.com/CheyYuAn/CueTap) ![Freeware][Freeware Icon]
