...
* [CueTap](https://github.com/CheyYuAn/CueTap) - 把事先准备好的文本按敲击逐字回放，让现场演示和录屏不会打错字。 [![Open-Source Software][OSS Icon]](https://github.com/CheyYuAn/CueTap) ![Freeware][Freeware Icon]
