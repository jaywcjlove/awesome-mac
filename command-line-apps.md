...
* [mac-storage-cleaner](https://github.com/JubaKitiashvili/mac-storage-cleaner) - macOS disk cleaner with a preview-first workflow: previews every deletion by default, auto-clears only a vetted allowlist of caches, and moves riskier items to Trash, while a code-enforced denylist backed by a 47-path test corpus blocks Photos libraries, backups, keychains, and SSH keys, and every action is written to an audit log. [![Open-Source Software][OSS Icon]](https://github.com/JubaKitiashvili/mac-storage-cleaner) ![Freeware][Freeware Icon]
