...
* [Friday](https://hellofriday.ai/) - 共有可能なワークスペース、MCPツール、スキル、メモリ、cron/Webhook自動化を備えたエージェントハーネスプラットフォーム。ソース公開: [friday-platform/friday-studio](https://github.com/friday-platform/friday-studio)。
