...
* [OOMU](https://oomu.ai) - Apple Silicon向けネイティブMac AIワークステーション（29 MB、アイドル時CPU 0.0%）。ローカルルーティング、コンテキスト圧縮、ネイティブOfficeドキュメント生成に対応。 ![Freeware][Freeware Icon] ![Native App][Native Icon]
