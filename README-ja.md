...
* [Weesper Transcribe](https://weesperneonflow.ai/en/transcribe/?utm_source=awesome_mac&utm_medium=directory&utm_campaign=transcribe_launch) - Mac向けのオフライン音声・動画文字起こしツールで、検索可能な履歴とTXT、Markdown、SRT/VTT、PDF書き出しに対応。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id6778776535?platform=mac)
