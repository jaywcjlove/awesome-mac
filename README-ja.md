...
* [CopySight](https://copysight.guillermozubikarai.dev/en) - 任意の画面領域からプライベートなオンデバイスOCRでテキストをコピーできるオープンソースのメニューバーツール。 [![Open-Source Software][OSS Icon]](https://github.com/copysightapp/copysight) ![Freeware][Freeware Icon] ![Native App][Native Icon]
