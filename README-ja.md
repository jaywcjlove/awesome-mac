...
* [CrossPaste](https://crosspaste.com/en/) - ローカルネットワーク経由でデバイス間のコピー＆ペーストをエンドツーエンド暗号化で同期するオープンソースのクリップボード。 [![Open-Source Software][OSS Icon]](https://github.com/CrossPaste/crosspaste-desktop) ![Freeware][Freeware Icon]
