...
* [SparlaCopy](https://github.com/jeroensparla/sparlacopy) - 番号付きスロット、FIFOキュー、プレーンテキスト変換、スマートな貼り付けプロファイルを備えたオープンソースのメニューバー型クリップボードツール。 [![Open-Source Software][OSS Icon]](https://github.com/jeroensparla/sparlacopy) ![Freeware][Freeware Icon] ![Native App][Native Icon]
