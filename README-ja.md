...
* [OpenVoiceFlow](https://openvoiceflow.com/) - 無料・オープンソースのプッシュ・トゥ・トーク音声入力。WhisperKitで端末上で文字起こしし、任意でテキスト整形も可能。 [![Open-Source Software][OSS Icon]](https://github.com/shimoverse/openvoiceflow) ![Freeware][Freeware Icon]
