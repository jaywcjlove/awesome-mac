...
* [LidOn](https://github.com/echod3v/LidOn) - ふたを閉じても MacBook を動かし続け、温度とバッテリーの保護機能を備え、AI エージェントが MCP 経由で自らスリープ防止を要求できます。 [![Open-Source Software][OSS Icon]](https://github.com/echod3v/LidOn) ![Freeware][Freeware Icon]
