...
* [Qwen Scribe](https://github.com/VladUZH/qwen-scribe) - Mac の GPU で Qwen3-ASR をローカル実行する、ファイル文字起こしとホールド・トゥ・トーク音声入力ツール。 [![Open-Source Software][OSS Icon]](https://github.com/VladUZH/qwen-scribe) ![Freeware][Freeware Icon]
