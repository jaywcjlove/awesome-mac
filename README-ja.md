...
* [NotchBuddy](https://notchbuddy.app) - MacBookのノッチを19個のツールのパネルに変えるアプリ。Stripe・RevenueCat・Polarなどの決済サービスの売上通知、ポモドーロタイマー、クリップボード履歴、AirDrop対応のファイルシェルフ、アニメーションするペット付き。![Native App][Native Icon]
