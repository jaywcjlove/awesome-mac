...
* [Hostflip](https://github.com/heronapp/hostflip) - メニューバーでのプロファイル切り替え、外部変更の差分レビュー、SwitchHostsからの移行に対応したオープンソースのネイティブhostsファイルマネージャー。 [![Open-Source Software][OSS Icon]](https://github.com/heronapp/hostflip) ![Freeware][Freeware Icon] ![Native App][Native Icon]
