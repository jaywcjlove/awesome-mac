...
* [Hop](https://hop.tools) - 毎日使う 18 のツールをメニューバーのひとつのパネルに。タイマー、タイムトラッカー、スリープ防止、システムモニター、クリップボード履歴、ファイル変換、ウィンドウ管理、編集機能つきスクリーンショット、画面への書き込み、文字認識など。使わないモジュールはオフのままで読み込まれません。[![Open-Source Software][OSS Icon]](https://github.com/antonyshakirov/hop) ![Freeware][Freeware Icon] ![Native App][Native Icon]
