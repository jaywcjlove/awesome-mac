...
* [PullMark](https://pullmark.app/ja/) - レンダリングされた差分と単語単位のハイライトでGitHub PRをレビューでき、コーディングエージェントが処理できるマージンノートに対応したネイティブMarkdownリーダー。UIは8言語対応。 [![Open-Source Software][OSS Icon]](https://github.com/jedijashwa/pullmark) ![Freeware][Freeware Icon]
