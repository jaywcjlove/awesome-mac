...
* [Recall](https://github.com/cnazk/recall-mac) - オンデバイスAIで意味から検索でき、検出した認証情報を自動で削除する、ローカルファーストのクリップボードマネージャー。 [![Open-Source Software][OSS Icon]](https://github.com/cnazk/recall-mac) ![Freeware][Freeware Icon]
