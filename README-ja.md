...
* [Crest](https://crestnotch.app/crest) - MacBookのノッチを、再生中の曲、カレンダー、ToDo、システム情報、Claude Codeの承認を並べたライブタイルのパネルに広げる。ノッチのないMacでは画面上部の小さなピルとして表示。 ![Freeware][Freeware Icon]
