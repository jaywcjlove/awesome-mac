...
* [PuppyOne](https://www.puppyone.ai) - あなたと AI が同じファイルで作業するローカルファーストのワークスペース。 [![Open-Source Software][OSS Icon]](https://github.com/puppyone-ai/puppyone-desktop) ![Freeware][Freeware Icon]
