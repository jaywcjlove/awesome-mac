...
* [Codex Account Switcher](https://github.com/liuzhao1225/codex-account-switcher) - ターミナルコマンドや設定ファイルの編集なしで複数のCodexアカウントを切り替えられる、ネイティブのメニューバーアプリ。 [![Open-Source Software][OSS Icon]](https://github.com/liuzhao1225/codex-account-switcher) ![Freeware][Freeware Icon] ![Native App][Native Icon]
