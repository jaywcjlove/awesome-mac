...
* [Tabnax](https://github.com/danmartuszewski/tabnax) - 固定の文字ショートカットとタイトル・URL検索でウィンドウやブラウザータブを切り替えるツール。 [![Open-Source Software][OSS Icon]](https://github.com/danmartuszewski/tabnax) ![Freeware][Freeware Icon]
