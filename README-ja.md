...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - ノッチの有無を問わずどの Mac でも使える Dynamic Island に、10 のユーティリティを加えた軽量メニューバーアプリ：スリープ防止、ウィンドウ単位の ⌘Tab、ウィンドウ配置とレイアウト、クリップボード履歴、アプリ別音量とイコライザー、パフォーマンス監視、OCR、アプリの完全削除。 [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
