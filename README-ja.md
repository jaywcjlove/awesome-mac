...
* [Calyx](https://github.com/yuuichieguchi/Calyx) - libghostty 上に構築されたネイティブターミナルで、複数のコーディングエージェントを並列に実行し、各エージェントの状態表示と承認インボックスで監督できます。 [![Open-Source Software][OSS Icon]](https://github.com/yuuichieguchi/Calyx) ![Freeware][Freeware Icon]
