...
* [Claude Code Local](https://github.com/nicedreamzapp/claude-code-local) - Anthropic API互換のローカルMLXサーバーで、Apple Silicon上でClaude Codeを完全にオンデバイス実行するツール。 [![Open-Source Software][OSS Icon]](https://github.com/nicedreamzapp/claude-code-local) ![Freeware][Freeware Icon]
