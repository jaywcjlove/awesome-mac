...
* [KIAgent](https://localkiagent.com) - パーソナルデジタルメモリ：メール、チャット、ドキュメントをローカルのSQLiteデータベースにインデックスし、MCP経由でAIアシスタントに提供。 [![Open-Source Software][OSS Icon]](https://github.com/edjafarov/kiagent-core) ![Freeware][Freeware Icon]
