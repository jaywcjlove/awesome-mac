...
* [KinetAios](https://github.com/phinn/KinetAios) - ローカルファーストのマルチエンジンAIエージェントダッシュボード。Claude Code、Codex、内蔵ReActエンジンを1つのウィンドウで並列実行し、エンジン横断の共有メモリ、MCP、プラグインに対応。 [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/phinn/KinetAios)
