...
* [Vyact](https://github.com/vyact/vyact) - ローカルLLMとのチャット、ドキュメントRAG、MCPツールに対応したオープンソースのAIワークスペース。 [![Open-Source Software][OSS Icon]](https://github.com/vyact/vyact) ![Freeware][Freeware Icon]
