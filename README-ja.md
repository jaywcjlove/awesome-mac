...
* [Orthant](https://orthant.app) - グリッドベースのウィンドウマネージャー。ショートカットでスナップするか、グリッドを呼び出してウィンドウの配置先を描き、その形をショートカットとして保存できます。 [![Open-Source Software][OSS Icon]](https://github.com/orthant-app/orthant) ![Freeware][Freeware Icon]
