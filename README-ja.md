...
* [Agent Island](https://github.com/tristan666666/agent-island) - Claude、Codex、Antigravity、Grok、Cursorに対応し、ローカルのセッション状態、ユーザー対応通知、プロバイダー使用量を表示する無料のオープンソースネイティブコンパニオン。 [![Open-Source Software][OSS Icon]](https://github.com/tristan666666/agent-island) ![Freeware][Freeware Icon]
