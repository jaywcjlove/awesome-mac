...
* [Parakey](https://github.com/rcourtman/parakey) - Parakeet-MLXによるオンデバイス文字起こし対応の軽量なプッシュトゥトーク音声入力ツール。 [![Open-Source Software][OSS Icon]](https://github.com/rcourtman/parakey) ![Freeware][Freeware Icon]
