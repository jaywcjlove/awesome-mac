...
* [Parakey](https://github.com/rcourtman/parakey) - Apple Neural Engine 上で CoreML により Parakeet TDT v3 を実行するプッシュトゥトーク音声入力ツール。キー解放から貼り付けまで約 100 ms、ネイティブ Swift バイナリ 2.2 MB。 [![Open-Source Software][OSS Icon]](https://github.com/rcourtman/parakey) ![Freeware][Freeware Icon]
