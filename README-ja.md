...
* [QuotaBar](https://roketrp.github.io/QuotaBar/) - OpenAI Codexの5時間・週間使用上限、リセットまでの時間、オプション通知を確認できるローカルファーストのメニューバーアプリ。 [![Open-Source Software][OSS Icon]](https://github.com/RoketrP/QuotaBar) ![Freeware][Freeware Icon]
