...
* [Remuda](https://github.com/magna-nz/remuda) - ローカルのOllamaモデルとチャットしながら同じウィンドウでModelfileを編集。A/B比較と編集履歴に対応。 [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/magna-nz/remuda)
