...
* [Tura](https://turaai.net/) - ターミナルとデスクトップのインターフェース、構造化されたコマンド実行、クラウドまたはローカルモデルへの対応を備えたオープンソースのローカルコーディングエージェント。 [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
