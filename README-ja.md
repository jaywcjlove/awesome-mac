...
* [Vibe Corgi](https://vibecorgi.net) - Claude Code や Codex の作業中は走り、承認が必要になると待ち、セッションが終わると休むコーギーのメニューバーコンパニオン、ライセンスは買い切り $4.99、最大 5 台の Mac で使用可。 ![Native App][Native Icon]
