...
* [OwlOCR](https://owlocr.com/) - 画面や画像からテキストを抽出し、検索可能な PDF を作成できるオンデバイス OCR ツール。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/id6462355119?platform=mac)
