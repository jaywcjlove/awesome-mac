...
* [noswoosh](https://github.com/mmathys/noswoosh) - 3本指スワイプまたはCtrl+矢印キーでmacOSのスペースをアニメーションなしで瞬時に切り替えるツール。 [![Open-Source Software][OSS Icon]](https://github.com/mmathys/noswoosh) ![Freeware][Freeware Icon]
