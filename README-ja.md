...
* [Textbutler](https://textbutler.app) - 選択したiMessage、WhatsApp、Beeperのチャットに対応するAIバトラー。Mac上で動作し、明確にマークされたアシスタントとして応答します。 [![Open-Source Software][OSS Icon]](https://github.com/hraness/textbutler) ![Freeware][Freeware Icon]
