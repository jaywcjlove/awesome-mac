...
* [Tomatino](https://tomatino.app) - メニューバーのポモドーロタイマー。セッションを開始すると集中モードをオンにして音楽を再生し、休憩で両方をオフに戻す。 [![App Store][app-store Icon]](https://apps.apple.com/app/id6807839006?platform=mac) ![Native App][Native Icon]
