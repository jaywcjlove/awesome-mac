...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - 7つのMacユーティリティを1つにまとめた軽量メニューバーアプリ：スリープ防止、ウィンドウ単位の⌘Tab、ダイナミックノッチ（音楽、AirDrop、カレンダー、アプリ別音量、タイマー）、ウィンドウスナップとレイアウト、クリップボード履歴、OCR、サウンド。 [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
