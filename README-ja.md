...
* [WindowHop](https://windowhop.martonpaulo.com/) - ウィンドウごとにタイルを表示し、選んだウィンドウに直接切り替えるオープンソースのウィンドウスイッチャー。 [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/martonpaulo/windowhop)
