...
* [WinKeys](https://github.com/neural-beat/winkeys) - Windows のキーボードショートカットを macOS でもそのまま使えるようにする、乗り換えたばかりの人のためのツール。 [![Open-Source Software][OSS Icon]](https://github.com/neural-beat/winkeys) ![Freeware][Freeware Icon]
