...
* [Relic](https://relic.space/) - ローカルファーストのエンドツーエンド暗号化クリップボード保管庫。永続的な履歴、デバイス上での AI 検索、任意のセルフホスト同期に対応。 [![Open-Source Software][OSS Icon]](https://github.com/RelicSync/relic) ![Freeware][Freeware Icon]
