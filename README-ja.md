...
* [MOLTamp](https://moltamp.com/) - AI ターミナルエージェント（Claude Code、Codex CLI、Gemini CLI、Aider、Cursor CLI）をテーマ対応のスキン、ウィジェット、オーディオビジュアライザー、コミュニティマーケットプレイスを備えたカスタマイズ可能なコックピット UI で包むシェル。 ![Freeware][Freeware Icon]
