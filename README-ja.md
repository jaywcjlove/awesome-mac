...
* [Holeberry](https://github.com/pedrovieira/Holeberry) - Pi-hole インスタンスを監視・制御できるネイティブでモダンな macOS メニューバーアプリ。 [![Open-Source Software][OSS Icon]](https://github.com/pedrovieira/Holeberry) ![Freeware][Freeware Icon]
