...
* [macharden](https://github.com/jankesec/macharden) - エンタープライズグレードの macOS セキュリティ監査、ベースラインドリフト、および堅牢化エンジン。 [![Open-Source Software][OSS Icon]](https://github.com/jankesec/macharden) ![Freeware][Freeware Icon]
