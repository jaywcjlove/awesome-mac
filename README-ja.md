...
* [Deckboy](https://github.com/Utopian-Academy/Deckboy) - ライブ映像向けのキューベースのメディア再生・ショーコントロールソフト。SRT 配信、録画、スライド用のプレゼンター表示に対応。 [![Open-Source Software][OSS Icon]](https://github.com/Utopian-Academy/Deckboy) ![Freeware][Freeware Icon]
