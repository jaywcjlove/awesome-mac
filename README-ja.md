...
* [Unpeel](https://unpeel.com) - 複数のCLI AIエージェントセッション（Claude Code、Codex、Gemini CLIなど）を実行・監督できるアプリ。永続ターミナル、git worktreeによる分離、iPhoneからのリモート操作に対応。 ![Freeware][Freeware Icon]
