...
* [SpreadPaper](https://spreadpaper.app) - 1枚の高解像度の壁紙を複数のモニターにまたがって表示し、ベゼル幅の補正にも対応。 [![Open-Source Software][OSS Icon]](https://github.com/spreadpaper/SpreadPaper) ![Freeware][Freeware Icon]
