...
* [Aman Disk](https://github.com/MidZai/aman_disk) - Mac 内蔵ドライブの S.M.A.R.T. 健康状態、温度履歴、性能テストをわかりやすく表示。 [![Open-Source Software][OSS Icon]](https://github.com/MidZai/aman_disk) ![Freeware][Freeware Icon] ![Native App][Native Icon]
