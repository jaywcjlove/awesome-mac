...
* [Dictámelo](https://www.dictamelo.com/en) - ローカル音声モデルと任意のクラウドプロバイダーに対応したオープンソースのプッシュ・トゥ・トーク音声入力ツール [![Open-Source Software][OSS Icon]](https://github.com/sarrazola/dictamelo) ![Freeware][Freeware Icon]
