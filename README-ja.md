...
* [Recopy](https://recopy.devshift.biz) - プライバシー重視のクリップボード履歴マネージャーで、テキスト、画像、ファイル、コードを記録し、すべてをデバイス上に保持します。 [![App Store][app-store Icon]](https://apps.apple.com/us/app/recopy-smart-clipboard/id6760709269)
