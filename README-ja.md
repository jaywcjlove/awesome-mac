...
* [Pathly](https://pathly.sophinauta.com/ja/) - Finderからファイルやフォルダのフルパス、親ディレクトリ、file URL、Git相対パスをすばやくコピー。 ![Native App][Native Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/pathly-copy-file-paths/id6761799555?mt=12)
