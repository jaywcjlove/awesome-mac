...
* [Binders](https://binders.io) - 音声入力、会議メモ、検索できる仕事の記録をすべてデバイス上で行い、AIツール向けのMCPサーバーも備えるツール。 [![Open-Source Software][OSS Icon]](https://github.com/binders-io/app) ![Freeware][Freeware Icon]
