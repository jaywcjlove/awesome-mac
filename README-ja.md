...
* [Tally](https://github.com/guokuaile/tally) - MacBook のノッチに Claude Code / Codex のセッション状態と AI 利用枠を表示し、ワンクリックでセッションのターミナルへ戻れるツール。 [![Open-Source Software][OSS Icon]](https://github.com/guokuaile/tally) ![Freeware][Freeware Icon]
