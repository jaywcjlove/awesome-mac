...
* [Conduck](https://conduck.com/) - セルフホストまたは自分のAPIキーで使うAI向けのネイティブクライアント。Mac、iPhone、iPad、Apple Watch、CarPlayで音声対話に対応。 [![Open-Source Software][OSS Icon]](https://github.com/GigaDuckAI/conduck) ![Freeware][Freeware Icon]
