...
* [MenubarHide](https://www.sparrow.tec.br/menubar-hide/) - メニューバーのアイコンを隠し、メニューバー下のパネルに表示することで、ノッチに隠れないようにするツール。 [![Open-Source Software][OSS Icon]](https://github.com/junior-rj/menubar-hide) ![Freeware][Freeware Icon]
