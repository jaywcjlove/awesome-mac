...
* [Codex Profiles](https://github.com/Ducksss/codex-profiles) - 名前付きCodex CLIプロファイルを切り替え、ローカル状態を分離したChatGPTウィンドウを起動するオープンソースツール。 [![Open-Source Software][OSS Icon]](https://github.com/Ducksss/codex-profiles) ![Freeware][Freeware Icon]
