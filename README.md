...
* [Hop](https://hop.tools) - Eighteen everyday tools in one menu bar panel: timer, time tracker, keep-awake, system monitor, clipboard history, file converter, window layouts, screenshots with an editor, drawing over the screen, text recognition and more. Modules you don't need stay switched off and are never loaded. [![Open-Source Software][OSS Icon]](https://github.com/antonyshakirov/hop) ![Freeware][Freeware Icon] ![Native App][Native Icon]
