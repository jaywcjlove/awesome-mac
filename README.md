...
* [CodeBurn](https://codeburn.app) - Open-source menu bar app and CLI that tracks AI coding cost by project, model, and task across 40+ tools like Claude Code, Codex, and Cursor. [![Open-Source Software][OSS Icon]](https://github.com/getagentseal/codeburn) ![Freeware][Freeware Icon]
