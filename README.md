...
* [nika](https://nika.sh) - Workflow engine for AI: .nika.yaml DAGs statically checked before execution (schema, permits, cost), tamper-evident traces after; local-first via Ollama. . [![Open-Source Software][OSS Icon]](https://github.com/supernovae-st/nika) ![Freeware][Freeware Icon]
