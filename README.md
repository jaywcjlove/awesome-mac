...
* [Agent Cat](https://agentcat.app) - Menu bar app that shows usage and rate limits for Claude Code, Codex, Gemini, Copilot, Cursor and other coding agents from local files. ![Freeware][Freeware Icon]
