...
* [LidRun](https://lidrun.com) - Menu bar app that keeps your Mac awake with the lid closed so AI/dev agents (Claude Code, Cursor, Codex) keep running, with battery and thermal auto-stop. ![Freeware][Freeware Icon]
