...
* [Orkas](https://orkas.ai/?source=awesome_mac) - Open-source, local-first multi-agent desktop app where a Commander coordinates specialist agents for research, coding, data analysis, documents, and media. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Orkas-AI/Orkas)
