...
* [Oxel](https://pexper.com/oxel/) - Free, on-device AI image upscaler (2x/4x/8x) and background remover for Apple Silicon Macs. Runs Core ML models on the Neural Engine — no cloud, no uploads, no subscription. Batch processing via folder drop; preserves transparency on PNG upscale. ![Free][Free-icon] ![App Store][AppStore-icon]
