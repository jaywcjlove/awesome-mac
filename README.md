...
* [Llamaport](https://github.com/smkamranqadri/llamaport) - Run local GGUF models with llama-server: reads model headers, shows the launch command before it runs, and resumes Hugging Face downloads after a kill. [![Open-Source Software][OSS Icon]](https://github.com/smkamranqadri/llamaport) ![Freeware][Freeware Icon]
