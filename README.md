...
* [LanGuard](https://github.com/roypadina/LanGuard) - Turns Wi-Fi off when a wired Ethernet link is active, and back on when you unplug. Edge-based, wake-aware, no admin rights. [![Open-Source Software][OSS Icon]](https://github.com/roypadina/LanGuard) ![Freeware][Freeware Icon] ![Native App][Native Icon]
