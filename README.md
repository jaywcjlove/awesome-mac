...
* [StayAwake](https://github.com/TY-teo/StayAwake) - Menu bar app that keeps a MacBook awake while Claude Code, Codex, and Cursor finish long agent runs - including with the lid closed. One-time sudoers rule scoped to two pmset commands, IOPMAssertion-based, timed auto-off. ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/TY-teo/StayAwake)
