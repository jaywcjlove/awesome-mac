...
* [Relic](https://relic.space/) - Local-first, end-to-end encrypted clipboard vault with permanent history, on-device AI search, and optional self-hosted sync. [![Open-Source Software][OSS Icon]](https://github.com/RelicSync/relic) ![Freeware][Freeware Icon]
