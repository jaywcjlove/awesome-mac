...
* [Cinesalve](https://github.com/LucideLarp/cinesalve) - Repairs corrupt or truncated MP4 and MOV recordings by rebuilding the missing moov atom, so footage from a camera that lost power plays again. ![Native App][Native Icon]
