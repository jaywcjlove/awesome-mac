...
* [Orthant](https://orthant.app) - Grid-based window manager. Snap with shortcuts, or summon a grid and draw where the window should go, then save the shape as a shortcut of its own. [![Open-Source Software][OSS Icon]](https://github.com/orthant-app/orthant) ![Freeware][Freeware Icon]
