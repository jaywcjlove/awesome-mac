...
* [Voicely](https://voicely.art) - Offline dictation into any app, call recording with speaker labels, and file transcription on-device with Parakeet V3; includes an MCP server for AI coding agents. [![Open-Source Software][OSS Icon]](https://github.com/StulkovLD/Voicely) ![Freeware][Freeware Icon]
