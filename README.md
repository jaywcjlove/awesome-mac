...
* [Halopen](https://halopen.com) - Hold-to-talk menu bar dictation that transcribes verbatim, with an on-device privacy mode and a local audit log of every cloud call.
