...
* [Agent Approval Inbox](https://github.com/stomeonst/agent-approval-inbox-preview) - Local approval inbox for scripts and automations, with persistent action cards and append only JSONL audit logs.
