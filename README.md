...
* [claude-buddy](https://github.com/norbertsuski/claude-buddy) - Floating always-on-top widget showing what every local Claude Code session is doing, with per-session detail, a notch mode and the five-hour usage window. [![Open-Source Software][OSS Icon]](https://github.com/norbertsuski/claude-buddy) ![Freeware][Freeware Icon]
