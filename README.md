...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - Seven Mac utilities in one lightweight menu-bar app: keep-awake, ⌘Tab by windows, a dynamic notch (music, AirDrop, calendar, per-app volume, timer), window snapping and layouts, clipboard history, OCR and sound. [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
