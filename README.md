...
* [Unpeel](https://unpeel.com) - Native terminal app built on the Ghostty engine for running CLI AI agents (Claude Code, Codex, Gemini CLI, and more), with persistent sessions and iPhone remote control. ![Freeware][Freeware Icon]
