...
* [OpenClaw Easy](https://openclaw-easy.com) - AI assistant that connects LLMs (ChatGPT, Claude, Ollama) to WhatsApp, Telegram, Slack, and Discord. Runs locally, no server needed. ![Freeware][Freeware Icon]
