...
* [SSH Tunnel Manager](https://github.com/0fuz/ssh-tunnel-manager) - Menu bar app for managing SSH port forwards (local, remote, SOCKS, jump host) that auto-reconnects when the connection drops. [![Open-Source Software][OSS Icon]](https://github.com/0fuz/ssh-tunnel-manager) ![Freeware][Freeware Icon] ![Native App][Native Icon]
