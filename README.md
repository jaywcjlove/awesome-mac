...
* [Hazmat](https://github.com/dredozubov/hazmat) - macOS containment for AI coding agents — separate UID, Seatbelt sandboxing via `sandbox_init()`, PF anchors, DNS blocklists, backup/rollback. TLA+-checked design. [![Open-Source Software][OSS Icon]](https://github.com/dredozubov/hazmat) ![Native App][Native Icon] ![Freeware][Freeware Icon]
