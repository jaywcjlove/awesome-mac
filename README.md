...
* [SpeakCode](https://www.speakcode.ai) - Native macOS canvas for running Claude Code and Codex agents in parallel: one zoomable canvas of terminal nodes with live status per agent, plus live multiplayer sharing.
