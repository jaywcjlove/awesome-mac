...
* [Notchi](https://www.notch.website/) - Type into the MacBook notch to save a note, set a reminder, ask AI with your own provider key, or run a coding agent on a project folder. [![Open-Source Software][OSS Icon]](https://github.com/cyrus-cai/notchi) ![Freeware][Freeware Icon] ![Native App][Native Icon]
