...
* [Tally](https://github.com/guokuaile/tally) - Claude Code and Codex session status and AI usage quotas in the MacBook notch, with one-click jump back to each session's terminal. [![Open-Source Software][OSS Icon]](https://github.com/guokuaile/tally) ![Freeware][Freeware Icon]
