...
* [Edict](https://edict.sh) - On-device dictation built for driving AI coding agents; verbatim output, 25 European languages, diarized file transcription, and a local MCP server.
