...
* [mlx-serve](https://mlxserve.com/) - Run any LLM locally on Apple Silicon (MLX + GGUF) with an OpenAI- and Anthropic-compatible server, plus MLX Core, a native menu-bar app with chat, agent mode, and tool calling. [![Open-Source Software][OSS Icon]](https://github.com/ddalcu/mlx-serve) ![Freeware][Freeware Icon] ![Native App][Native Icon]
