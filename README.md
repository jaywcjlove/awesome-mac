...
* [Devie AI Quota Tracker](https://github.com/mathdevie/devie-ai-quota-tracker) - Dashboard and macOS menu bar for tracking AI subscription quotas (Claude Code, Codex, Gemini CLI, GitHub Copilot, and Cursor) in one place, with multi-account support, notifications, and session-timer start optimization. [![Open-Source Software][OSS Icon]](https://github.com/mathdevie/devie-ai-quota-tracker) ![Freeware][Freeware Icon]
