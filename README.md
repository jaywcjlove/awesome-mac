...
* [nastro](https://github.com/scaccogatto/nastro) - Open-source terminal call recorder that captures system audio and mic without a bot joining the call, then transcribes on-device with speaker diarization via TUI or headless CLI. [![Open-Source Software][OSS Icon]](https://github.com/scaccogatto/nastro) ![Freeware][Freeware Icon]
