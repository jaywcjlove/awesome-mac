...
* [Clavio](https://clavioapp.com) - AI hands-free dictation that adapts to every app, with a wake word, per-app tone, and optional auto-send. [`brew install --cask zhingel/clavio/clavio`]
