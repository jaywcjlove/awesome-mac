...
* [Vibe Island](https://vibeisland.app) - Turn the MacBook notch into a control panel for AI coding agents (Claude Code, Codex, Gemini CLI & more) — monitor sessions, approve permission requests, and jump back to the exact terminal pane.
