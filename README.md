...
* [MacPilot](https://github.com/misswell/MacPilot) - Open-source menu bar toolbox that combines per-app quit rules, BLE proximity unlock, window switching, clipboard history, smooth scrolling, PiP, screen capture, and screen recording in one native app. [![Open-Source Software][OSS Icon]](https://github.com/misswell/MacPilot) ![Freeware][Freeware Icon]
