...
* [llm-swarm-router](https://github.com/matthewdcage/llm-swarm-router) - Native menubar app + DMG for a local LLM mesh router (oMLX/Ollama/LM Studio/vLLM) with OpenAI + Anthropic API on `:11400`. [![Open-Source Software][OSS Icon]](https://github.com/matthewdcage/llm-swarm-router) ![Freeware][Freeware Icon]
