...
* [Codex Profiles](https://github.com/Ducksss/codex-profiles) - Open-source tool for switching named Codex CLI profiles and launching ChatGPT windows with separate local state. [![Open-Source Software][OSS Icon]](https://github.com/Ducksss/codex-profiles) ![Freeware][Freeware Icon]
