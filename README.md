...
* [ClaudeNotch](https://github.com/hidrogenone/ClaudeNotch) - Drops the MacBook notch down with a Dynamic-Island-style alert and a red screen-edge flash when Claude (status.claude.com) has an incident. [![Open-Source Software][OSS Icon]](https://github.com/hidrogenone/ClaudeNotch) ![Freeware][Freeware Icon]
