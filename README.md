...
* [WindowHop](https://windowhop.martonpaulo.com/) - Open-source window switcher that gives every window its own tile and switches to the exact one you pick. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/martonpaulo/windowhop)
