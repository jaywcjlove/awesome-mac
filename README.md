...
* [CrossGen](https://www.corgnitor.com/products/crossgen) - Local-first AI image workspace for generating, editing, organizing, and reusing images from the desktop app, JSON CLI, or MCP-compatible agents. [![Open-Source Software][OSS Icon]](https://github.com/Bliveren/CrossGen) ![Freeware][Freeware Icon]
