...
* [CrossPaste](https://crosspaste.com/en/) - Open-source cross-device clipboard that syncs copy and paste between machines over the local network with end-to-end encryption. [![Open-Source Software][OSS Icon]](https://github.com/CrossPaste/crosspaste-desktop) ![Freeware][Freeware Icon]
