...
* [qwen-audio-agent](https://github.com/QwenAudio/qwen-audio-agent) - Full-duplex voice interface for AI coding agents (Claude Code, Codex, OpenCode), with local wake word and barge-in. [![Open-Source Software][OSS Icon]](https://github.com/QwenAudio/qwen-audio-agent) ![Freeware][Freeware Icon]
