...
* [ClaudeUsage](https://github.com/davidlikescat/claude-code-usage-monitor) - Show Claude Code usage as a battery indicator in the menu bar, with remaining 5-hour session and 7-day limits and reset countdowns. [![Open-Source Software][OSS Icon]](https://github.com/davidlikescat/claude-code-usage-monitor) ![Freeware][Freeware Icon]
