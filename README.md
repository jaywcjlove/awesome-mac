...
* [Plonk](https://github.com/ostapondo/plonk) - Menu bar window manager an AI agent can drive over MCP: snap zones, hotkeys, and saved workspaces that relaunch apps into place. [![Open-Source Software][OSS Icon]](https://github.com/ostapondo/plonk) ![Freeware][Freeware Icon]
