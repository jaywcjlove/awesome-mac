...
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) - Records a coding agent below the harness — model traffic, shell exit codes, per-turn file changes and MCP calls on one timeline — then replays the run offline or forks it onto another model. [![Open-Source Software][OSS Icon]](https://github.com/Continuum-AI-Corp/OrcaReplay) ![Freeware][Freeware Icon]
