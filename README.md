...
* [Vibe Corgi](https://vibecorgi.net) - Menu bar companion whose corgi runs while Claude Code or Codex works, waits when the agent needs your approval, and rests when the session ends.
