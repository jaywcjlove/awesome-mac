...
* [ShiftBar](https://shiftbar.0x01.build) - Choose which menu bar icons to hide and manually expand or collapse them using native folding on macOS 27 (Apple Silicon). ![Native App][Native Icon]
