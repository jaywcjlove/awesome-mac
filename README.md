...
* [KyttoMCP](https://kytto.jakubhecht.sk/) - Manage MCP servers across Claude Desktop, Claude Code, Cursor, VS Code and Codex in one matrix, with health checks, a tool safety scan and local config backups. [![Open-Source Software][OSS Icon]](https://github.com/heyitsjakub/KyttoMCP) ![Freeware][Freeware Icon] ![Native App][Native Icon]
