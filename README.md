...
* [DeepSeek Harness for macOS](https://github.com/luochenw/deepseek-harness-macos) - Native SwiftUI client for the DeepSeek Harness agent (dsh): streaming sessions, live subagent overlay, menu bar approvals, bundled runtime — no WebView or Electron. [![Open-Source Software][OSS Icon]](https://github.com/luochenw/deepseek-harness-macos) ![Freeware][Freeware Icon]
