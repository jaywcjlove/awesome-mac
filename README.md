...
* [NoMicSwitch](https://github.com/marks-zyz/NoMicSwitch) - Pins the default audio input to the built-in mic and locks input volume, so AirPods never take the microphone over. [![Open-Source Software][OSS Icon]](https://github.com/marks-zyz/NoMicSwitch) ![Freeware][Freeware Icon]
