...
* [Sleepwing](https://lttxzmj.github.io/sleepwing/) - Desktop pet that watches local AI coding agents (Claude Code, Codex, Cursor…), turns their work time into real breaks, and recalls you when one needs input. [![Open-Source Software][OSS Icon]](https://github.com/lttxzmj/sleepwing) ![Freeware][Freeware Icon]
