...
* [Tura](https://turaai.net/) - Open-source local coding agent with terminal and desktop interfaces, structured command execution, and support for cloud or local models. [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
