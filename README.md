...
* [Clipboard Router](https://ibrolord.github.io/clipboard-router-releases/) - Open-source clipboard workspace with searchable history, sequential paste queues, reviewable automation, and protected clips. [![Open-Source Software][OSS Icon]](https://github.com/ibrolord/clipboard-router) ![Freeware][Freeware Icon] ![Native App][Native Icon]
