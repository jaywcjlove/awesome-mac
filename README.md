...
* [GEOKit](https://geokit.site) - Free Generative Engine Optimization (GEO) & AI SEO toolkit for llms.txt validation, AI crawler management, and readiness scoring. Available on Homebrew (`brew install gstar-byte/tap/geokit`). [![Open-Source Software][OSS Icon]](https://github.com/gstar-byte/geokit-cli) ![Freeware][Freeware Icon]
