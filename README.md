...
* [Usage HUD](https://usage-hud-store.pattern-service.workers.dev) - Native menu-bar meter for Claude, Codex, Gemini, Grok, and Ollama, with a confidence label on every number. [![Open-Source Software][OSS Icon]](https://github.com/Thalia-Bloom/usage-hud)
