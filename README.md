...
* [ListenIn](https://listenin.dev) - Menu-bar dictation for bilingual (zh/en) speakers: on-device recognition, LLM cleanup that preserves technical terms, and a mode that turns speech into structured prompts for AI coding agents. ![Freeware][Freeware Icon]
