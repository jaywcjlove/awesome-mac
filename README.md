...
* * [Floodtide](https://bhopstudio.com/floodtide) - Update every app on your Mac in one pass from each app's own Sparkle feed and the Homebrew catalog, with no version database to go stale.
