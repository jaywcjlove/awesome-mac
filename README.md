...
* [EKO](https://www.reactivepixels.com/eko) - Bit-perfect audiophile music player for Navidrome, Subsonic and local files, matching the output device to each file's sample rate, with a 10-band EQ, ReplayGain and gapless playback. [![Open-Source Software][OSS Icon]](https://github.com/reactivepixels/eko) ![Freeware][Freeware Icon]
