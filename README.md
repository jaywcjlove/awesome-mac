...
* [AudioRouterNow](https://audiorouternow.mauriciomorkun.com) - Menu bar app that routes one audio source to multiple outputs simultaneously, without building an aggregate device. Volume keys keep working; no kernel extension, no restart. macOS 14.4+. [![Open-Source Software][OSS Icon]](https://github.com/mauriciomorkun/AudioRouterNow) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/audiorouternow/id6787215635)
