...
* [PuppyOne](https://www.puppyone.ai) - A local-first workspace where you and your AI work on the same files. [![Open-Source Software][OSS Icon]](https://github.com/puppyone-ai/puppyone-desktop) ![Freeware][Freeware Icon]
