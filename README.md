...
* [Unpeel](https://unpeel.com) - Run and supervise multiple CLI AI agent sessions (Claude Code, Codex, Gemini CLI, and more) with persistent terminals, git worktree isolation, and iPhone remote control. ![Freeware][Freeware Icon]
