...
* [MyUsage](https://zchan0.github.io/MyUsage/) - Menu bar tracker for Claude Code, Codex, Cursor, and Antigravity that aggregates usage across multiple Macs via a sync folder you already use, with no backend. [![Open-Source Software][OSS Icon]](https://github.com/zchan0/MyUsage) ![Freeware][Freeware Icon]
