...
* [Nocturne](https://github.com/dotcomjack/nocturne) - Makes the menu bar clock unreadable so it stops telling you how late it is, without hiding anything or asking for permissions. [![Open-Source Software][OSS Icon]](https://github.com/dotcomjack/nocturne) ![Freeware][Freeware Icon] ![Native App][Native Icon]
