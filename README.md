...
* [Guard](https://guard-app.net) - Camera access monitor that freezes processes with SIGSTOP until you approve. [![Open-Source Software][OSS Icon]](https://github.com/FaisalFehad/Guard) ![Freeware][Freeware Icon]
