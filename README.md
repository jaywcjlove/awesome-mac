...
* [CopySight](https://copysight.guillermozubikarai.dev/en) - Open-source menu bar utility for copying text from any screen region with private, on-device OCR. [![Open-Source Software][OSS Icon]](https://github.com/copysightapp/copysight) ![Freeware][Freeware Icon] ![Native App][Native Icon]
