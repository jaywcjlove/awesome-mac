...
* [OneTake](https://screenrecorder.link/) - Chrome extension that records a browser tab and encodes the GIF or MP4 in the page, then uploads only the finished file for a share link. ![Freeware][Freeware Icon]
