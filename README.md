...
* [NoxKey](https://noxkey.ai) - Keychain-based secret manager with Touch ID. Stores API keys and tokens in the macOS Secure Enclave, detects AI agents via process-tree walking, and delivers secrets through encrypted handoff. [![Open-Source Software][OSS Icon]](https://github.com/No-Box-Dev/Noxkey) ![Freeware][Freeware Icon]
