...
* [KinetAios](https://github.com/phinn/KinetAios) - Local-first multi-engine AI agent dashboard that runs Claude Code, Codex, and a built-in ReAct engine side by side with shared cross-engine memory, MCP, and plugins. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/phinn/KinetAios)
