...
* [Remuda](https://github.com/magna-nz/remuda) - Chat with a local Ollama model and edit its Modelfile in the same window, with A/B compare and Modelfile history. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/magna-nz/remuda)
