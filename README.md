...
* [Claude Desktop Usage](https://github.com/eastonsuo/claude-desktop-usage) - Menu bar widget that shows your Claude.ai 5-hour and weekly usage with reset timers, read locally from the logged-in Claude desktop app session. [![Open-Source Software][OSS Icon]](https://github.com/eastonsuo/claude-desktop-usage) ![Freeware][Freeware Icon]
