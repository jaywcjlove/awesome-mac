...
* [Mac Developer Bridge](https://github.com/alexanderradahl/mac-developer-bridge) - Open-source MCP bridge that lets ChatGPT use local shell, files, PTY sessions, background jobs, and read-only Codex history. [![Open-Source Software][OSS Icon]](https://github.com/alexanderradahl/mac-developer-bridge) ![Freeware][Freeware Icon]
