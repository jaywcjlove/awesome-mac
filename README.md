...
* [CodeAgentSwarm](https://www.codeagentswarm.com) - Run multiple AI coding agents (Claude Code, Codex CLI, Gemini CLI) in parallel supervised terminals, with notifications, session history and a kanban board. ![Freeware][Freeware Icon]
