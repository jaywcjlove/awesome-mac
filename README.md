...
* [Mac App Cleaner](https://github.com/rblyz/mac-app-cleaner) - Terminal-based uninstaller in pure bash. Finds app leftovers, orphaned junk, and brew/pip packages. Moves everything to Trash, never `rm -rf`. ![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]
