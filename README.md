...
* [Performance Monitor](https://perfmon.knhome.nl) - Lightweight system monitor for the menu bar: CPU, memory, network, disk, GPU, per-sensor temperatures, SSD wear, and battery health. No telemetry. [![Open-Source Software][OSS Icon]](https://github.com/inequitas/performancemonitor) ![Freeware][Freeware Icon]
