...
* [BannerHither](https://github.com/KJeon10/BannerHither) - Moves macOS notification banners to the display you are looking at: the screen under the mouse pointer, the screen of the active window, or a fixed display. [![Open-Source Software][OSS Icon]](https://github.com/KJeon10/BannerHither) ![Freeware][Freeware Icon] ![Native App][Native Icon]
