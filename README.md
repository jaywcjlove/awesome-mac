...
* [Tura](https://turaai.net/) - Local-first open-source coding agent with CLI, TUI, desktop, and web interfaces plus OpenAI-compatible and local model support. [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
