...
* [Vibedock](https://vibedock.dev) - macOS menu bar app for toggling Claude Code MCP servers on and off. Toggle, kill and relaunch sessions instantly — no config files needed.
