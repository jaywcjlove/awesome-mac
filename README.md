...
* [Spyglass](https://magicelklabs.com/spyglass/) - Quick Look extension that previews Google Drive stub files (.gdoc, .gsheet, .gslides and others) instead of showing their JSON. ![Native App][Native Icon]
