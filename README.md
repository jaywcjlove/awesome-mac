...
* [Tally](https://github.com/jettoai/tally) - Menu bar dashboard showing the quota windows of multiple Claude and Codex accounts side by side, with a launcher that starts each session on the account with the most quota left. [![Open-Source Software][OSS Icon]](https://github.com/jettoai/tally) ![Freeware][Freeware Icon] ![Native App][Native Icon]
