...
* [Local MCP](https://local-mcp.com) - Connects Claude, ChatGPT, Cursor and VS Code to Mail, Calendar, Contacts, iMessage, Microsoft Teams, Slack, WhatsApp, OneDrive and local files — 230+ tools, all on-device. ![Freeware][Freeware Icon] ![Native App][Native Icon]
