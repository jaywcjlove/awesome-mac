...
* [dictate](https://github.com/lewiswigmore/macOS-dictate) - Privacy-first voice typing for macOS. Free alternative to Wispr Flow with local Whisper, optional Ollama or OpenRouter cleanup, per-app vocab and a loopback-only history WebUI. [![Open-Source Software][OSS Icon]](https://github.com/lewiswigmore/macOS-dictate) ![Freeware][Freeware Icon]
