...
* [Valpas](https://kirsulab.com/macos/valpas) - Menu bar switch that keeps your Mac awake for a set time, with a countdown and rules that start it on the power adapter, with an external display or while an app runs. ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/us/app/valpas-keep-machine-awake/id6803307242)
