...
* [EnviousWispr](https://enviouswispr.com) - Free, sub-second dictation running dual Whisper and Parakeet engines locally. Text is polished entirely on-device using Apple Intelligence by default, with optional API support for cloud LLMs. ![Freeware][Freeware Icon]
