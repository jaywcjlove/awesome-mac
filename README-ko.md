...
* [claude-buddy](https://github.com/norbertsuski/claude-buddy) - 로컬 Claude Code 세션의 상태를 항상 위에 띄워 보여주는 플로팅 위젯입니다. 세션별 상세 정보, 노치 모드, 5시간 사용량 창을 지원합니다. [![Open-Source Software][OSS Icon]](https://github.com/norbertsuski/claude-buddy) ![Freeware][Freeware Icon]
