...
* [Crest](https://crestnotch.app/crest) - Claude Code와 Codex의 권한 요청을 노치에 띄워 한 번의 탭으로 승인하는 노치 패널로, 지금 재생 중, 캘린더, 할 일, 시스템 상태 타일도 담았고, 노치가 없는 맥에서는 화면 상단의 작은 알약 형태로 표시됩니다.
