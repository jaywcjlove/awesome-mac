...
* [Human Eyes](https://github.com/neural-beat/human-eyes) - Claude Code와 Codex 기록(세션, 메모리 노트, 스킬, MCP 서버)을 탐색·검색하고 그래프로 시각화. 모든 데이터는 Mac에만 저장. [![Open-Source Software][OSS Icon]](https://github.com/neural-beat/human-eyes) ![Freeware][Freeware Icon] ![Native App][Native Icon]
