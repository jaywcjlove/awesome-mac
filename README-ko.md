...
* [Tomatino](https://tomatino.app) - 메뉴 막대 포모도로 타이머. 세션을 시작하면 집중 모드를 켜고 음악을 재생하며, 휴식에는 둘 다 끕니다. [![App Store][app-store Icon]](https://apps.apple.com/app/id6807839006?platform=mac) ![Native App][Native Icon]
