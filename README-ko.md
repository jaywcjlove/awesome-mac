...
* [Orthant](https://orthant.app) - 그리드 기반 창 관리자. 단축키로 창을 스냅하거나 그리드를 불러와 창을 놓을 위치를 그리고, 그 모양을 전용 단축키로 저장할 수 있습니다. [![Open-Source Software][OSS Icon]](https://github.com/orthant-app/orthant) ![Freeware][Freeware Icon]
