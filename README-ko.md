...
* [Recall](https://github.com/cnazk/recall-mac) - 온디바이스 AI로 의미 기반 검색을 제공하고, 감지된 자격 증명을 자동으로 삭제하는 로컬 우선 클립보드 관리자. [![Open-Source Software][OSS Icon]](https://github.com/cnazk/recall-mac) ![Freeware][Freeware Icon]
