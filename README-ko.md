...
* [CopySight](https://copysight.guillermozubikarai.dev/en) - 화면의 어느 영역에서나 비공개 온디바이스 OCR로 텍스트를 복사하는 오픈 소스 메뉴 바 도구. [![Open-Source Software][OSS Icon]](https://github.com/copysightapp/copysight) ![Freeware][Freeware Icon] ![Native App][Native Icon]
