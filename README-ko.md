...
* [Notchi](https://www.notch.website/) - MacBook 노치에 입력하는 것만으로 메모 저장, 미리 알림 설정, 자신의 API 키로 AI 질문, 프로젝트 폴더에서 코딩 에이전트 실행까지 할 수 있는 앱. [![Open-Source Software][OSS Icon]](https://github.com/cyrus-cai/notchi) ![Freeware][Freeware Icon] ![Native App][Native Icon]
