...
* [Calyx](https://github.com/yuuichieguchi/Calyx) - libghostty 기반의 네이티브 터미널로, 코딩 에이전트를 병렬로 실행하고 실시간 상태와 단일 승인 인박스로 감독합니다. [![Open-Source Software][OSS Icon]](https://github.com/yuuichieguchi/Calyx) ![Freeware][Freeware Icon]
