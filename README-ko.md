...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - 노치 유무와 관계없이 모든 Mac에서 쓰는 Dynamic Island에 열 가지 유틸리티를 더한 가벼운 메뉴 막대 앱: 잠자기 방지, 창 단위 ⌘Tab, 창 배치와 레이아웃, 클립보드 기록, 앱별 음량과 이퀄라이저, 성능 모니터, OCR, 앱 완전 삭제. [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
