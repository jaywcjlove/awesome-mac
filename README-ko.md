...
* [Vyact](https://github.com/vyact/vyact) - 로컬 LLM 채팅, 문서 RAG, MCP 도구를 지원하는 오픈 소스 AI 작업 공간. [![Open-Source Software][OSS Icon]](https://github.com/vyact/vyact) ![Freeware][Freeware Icon]
