...
* [CrossPaste](https://crosspaste.com/en/) - 로컬 네트워크에서 기기 간 복사·붙여넣기를 종단간 암호화로 동기화하는 오픈소스 클립보드. [![Open-Source Software][OSS Icon]](https://github.com/CrossPaste/crosspaste-desktop) ![Freeware][Freeware Icon]
