...
* [Headroom](https://headroom.walls.sh) - Claude Code의 5시간 세션과 7일 주간 사용률을 실시간 %로 표시하고 한도에 가까워지면 색상으로 알려주는 사용량 미터. [![Open-Source Software][OSS Icon]](https://github.com/patwalls/headroom) ![Freeware][Freeware Icon]
