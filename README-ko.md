...
* [MetaClean](https://github.com/Moresyl/metaclean) - 이미지, Office 문서, PDF 및 텍스트 파일에서 메타데이터를 제거하는 오픈 소스 오프라인 도구입니다. [![Open-Source Software][OSS Icon]](https://github.com/Moresyl/metaclean) ![Freeware][Freeware Icon]
