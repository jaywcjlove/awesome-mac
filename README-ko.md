...
* [Tura](https://turaai.net/) - CLI, TUI, 데스크톱, 웹 인터페이스를 제공하고 OpenAI 호환 API와 로컬 모델을 지원하는 로컬 우선 오픈 소스 AI 코딩 에이전트. [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
