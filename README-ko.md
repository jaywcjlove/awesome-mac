...
* [Quant Voice](https://github.com/avklyuev79-hash/quant-voice) - Whisper를 기기에서 실행해 인식한 텍스트를 커서 위치에 삽입하는 오프라인 음성 받아쓰기 도구. [![Open-Source Software][OSS Icon]](https://github.com/avklyuev79-hash/quant-voice) ![Freeware][Freeware Icon]
