...
* [Plainsay](https://plainsay.app/) - Whisper 또는 Parakeet으로 기기 내에서 변환하는 음성 받아쓰기 앱. 직접 관리하는 키를 사용한 텍스트 다듬기 과정도 선택적으로 제공. [![Open-Source Software][OSS Icon]](https://github.com/conrader/plainsay) ![Freeware][Freeware Icon]
