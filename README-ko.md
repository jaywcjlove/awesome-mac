...
* [WinKeys](https://github.com/neural-beat/winkeys) - 윈도우 키보드 단축키를 macOS에서 그대로 사용할 수 있게 해주는 도구. 맥으로 막 넘어온 사용자를 위한 것. [![Open-Source Software][OSS Icon]](https://github.com/neural-beat/winkeys) ![Freeware][Freeware Icon]
