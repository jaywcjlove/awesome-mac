...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - 일곱 가지 Mac 유틸리티를 하나로 합친 가벼운 메뉴 막대 앱: 잠자기 방지, 창 단위 ⌘Tab, 다이내믹 노치(음악, AirDrop, 캘린더, 앱별 음량, 타이머), 창 스냅과 레이아웃, 클립보드 기록, OCR, 사운드. [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
