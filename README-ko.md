...
* [PromptBar](https://promptbar.peterdsp.dev) - 사용자 제공 URL, 키, 프롬프트로 웹 채팅과 OpenAI 호환 엔드포인트를 연결하는 메뉴 막대 AI 채팅 컨테이너. [![App Store][app-store Icon]](https://apps.apple.com/app/promptbar/id6743766769?mt=12)
