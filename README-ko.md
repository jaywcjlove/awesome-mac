...
* [Tura](https://turaai.net/) - 터미널 및 데스크톱 인터페이스, 구조화된 명령 실행, 클라우드 또는 로컬 모델 지원을 제공하는 오픈 소스 로컬 코딩 에이전트. [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
