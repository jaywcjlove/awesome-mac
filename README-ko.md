...
* [Nodes](https://nodes-web.com) - Markdown, PDF, 이미지 노트를 위한 macOS 네이티브 지식 관리 앱. 위키 스타일 링크, LaTeX, 전문 검색, 포스 유도 그래프를 지원합니다. ![Native App][Native Icon] [![App Store][app-store Icon]](https://apps.apple.com/app/nodes-by-the-werk/id6745401961?platform=mac)
