...
* [MacCam](https://github.com/polyackiy/MacCam) - Mac 카메라를 오프라인 동작 감지 보안 카메라로 만드는 메뉴 막대 앱. [![Open-Source Software][OSS Icon]](https://github.com/polyackiy/MacCam) ![Freeware][Freeware Icon]
