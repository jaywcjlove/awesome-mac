...
* [Flitdrop](https://flitdrop.com/) - 로컬 Wi-Fi로 모든 휴대폰과 컴퓨터 사이에서 파일, 사진, 클립보드를 주고받는 종단간 암호화 지원 도구로, 휴대폰에는 아무것도 설치할 필요 없이 QR 코드를 한 번만 스캔하면 됩니다. ![Freeware][Freeware Icon]
