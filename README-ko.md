...
* [Frame Player](https://frameplayer.app/) - mpv 기반 비디오 플레이어로 토렌트 스트리밍, TV 캐스팅, 동기화된 함께 보기를 지원합니다. [![Open-Source Software][OSS Icon]](https://github.com/risenxxx/frame-player) ![Freeware][Freeware Icon]
