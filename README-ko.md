...
* [Nori Clipboard](https://noriclipboard.com/en) - 시각적 기록과 재사용 가능한 다단계 붙여넣기 시퀀스를 제공하는 네이티브 클립보드 관리자. [![App Store][app-store Icon]](https://apps.apple.com/app/id6794883956?platform=mac) ![Native App][Native Icon]
