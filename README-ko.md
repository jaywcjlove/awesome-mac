...
* [Crest](https://crestnotch.app/crest) - 맥북 노치를 지금 재생 중, 캘린더, 할 일, 시스템 상태, Claude Code 승인을 담은 라이브 타일 패널로 펼쳐 주고, 노치가 없는 맥에서는 화면 상단의 작은 알약 형태로 표시됩니다. ![Freeware][Freeware Icon]
