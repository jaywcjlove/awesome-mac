...
* [Devie AI Quota Tracker](https://github.com/mathdevie/devie-ai-quota-tracker) - AI 구독 할당량(Claude Code, Codex, Gemini CLI, GitHub Copilot, Cursor)을 한곳에서 추적하는 대시보드 및 macOS 메뉴 막대 앱으로, 다중 계정, 알림, 세션 타이머 시작 최적화를 지원. [![Open-Source Software][OSS Icon]](https://github.com/mathdevie/devie-ai-quota-tracker) ![Freeware][Freeware Icon]
