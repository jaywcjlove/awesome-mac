...
* [Voicely](https://voicely.art) - 모든 앱에 입력되는 오프라인 받아쓰기, 화자 구분 통화 녹음, Parakeet V3 기반 온디바이스 파일 전사를 제공하며 AI 코딩 에이전트용 MCP 서버를 내장했습니다. [![Open-Source Software][OSS Icon]](https://github.com/StulkovLD/Voicely) ![Freeware][Freeware Icon]
