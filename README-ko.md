...
* [Recopy](https://recopy.devshift.biz) - 개인정보 보호를 우선하는 클립보드 기록 관리자로 텍스트, 이미지, 파일, 코드를 캡처하고 모든 내용을 기기에 보관합니다. [![App Store][app-store Icon]](https://apps.apple.com/us/app/recopy-smart-clipboard/id6760709269)
