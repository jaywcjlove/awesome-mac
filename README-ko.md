...
* [Friday](https://hellofriday.ai/) - 공유 가능한 워크스페이스, MCP 도구, 스킬, 메모리, cron/웹훅 자동화를 제공하는 에이전트 하니스 플랫폼. 소스 공개: [friday-platform/friday-studio](https://github.com/friday-platform/friday-studio).
