...
* [OOMU](https://oomu.ai) - Apple Silicon 전용 네이티브 Mac AI 워크스테이션(29 MB, 유휴 CPU 0.0%). 로컬 라우팅, 컨텍스트 압축 및 네이티브 Office 문서 생성 지원. ![Freeware][Freeware Icon] ![Native App][Native Icon]
