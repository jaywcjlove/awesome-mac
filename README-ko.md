...
* [KinetAios](https://github.com/phinn/KinetAios) - 로컬 퍼스트 멀티엔진 AI 에이전트 대시보드. Claude Code, Codex, 내장 ReAct 엔진을 한 창에서 나란히 실행하며 엔진 간 공유 메모리, MCP, 플러그인을 지원합니다. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/phinn/KinetAios)
