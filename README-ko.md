...
* [Pina Viewer](https://ayrapps.github.io/pina-viewer/) - 폴더와 압축 파일(cbz, cbr, 7z, PDF)을 바로 열고 전체 화면에서 키보드로 다음 책으로 넘어가는 이미지·만화 뷰어. ![Freeware][Freeware Icon] ![Native App][Native Icon]
