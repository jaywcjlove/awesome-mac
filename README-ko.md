...
* [Binders](https://binders.io) - 받아쓰기, 회의록, 검색 가능한 업무 기록을 모두 기기에서 처리하고 AI 도구용 MCP 서버를 제공하는 도구. [![Open-Source Software][OSS Icon]](https://github.com/binders-io/app) ![Freeware][Freeware Icon]
