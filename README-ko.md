...
* [Codex Quota Overlay](https://github.com/cpys/codex-quota-overlay) - Codex Desktop의 할당량, 재설정 시간, 재설정 크레딧을 대화 제목 옆에 표시하는 오픈 소스 오버레이. [![Open-Source Software][OSS Icon]](https://github.com/cpys/codex-quota-overlay) ![Freeware][Freeware Icon]
