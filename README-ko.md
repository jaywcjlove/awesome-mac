...
* [Tally](https://github.com/guokuaile/tally) - MacBook 노치에 Claude Code / Codex 세션 상태와 AI 사용 한도를 표시하고, 클릭 한 번으로 세션의 터미널로 돌아가는 도구. [![Open-Source Software][OSS Icon]](https://github.com/guokuaile/tally) ![Freeware][Freeware Icon]
