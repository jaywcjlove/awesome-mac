...
* [QuotaBar](https://roketrp.github.io/QuotaBar/) - OpenAI Codex의 5시간·주간 사용 한도, 재설정 카운트다운, 선택적 알림을 보여주는 로컬 우선 메뉴 막대 앱. [![Open-Source Software][OSS Icon]](https://github.com/RoketrP/QuotaBar) ![Freeware][Freeware Icon]
