...
* [Textbutler](https://textbutler.app) - 선택한 iMessage, WhatsApp, Beeper 채팅을 위한 AI 버틀러. Mac에서 실행되며 명확하게 표시된 어시스턴트로 응답합니다. [![Open-Source Software][OSS Icon]](https://github.com/hraness/textbutler) ![Freeware][Freeware Icon]
