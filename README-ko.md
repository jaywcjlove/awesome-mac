...
* [Read Assist](https://github.com/ai-nuke/read-assist) - 사용자가 명시적으로 요청한 뒤에만 선택한 단어와 문장을 설명하는 오픈 소스 읽기 도우미. [![Open-Source Software][OSS Icon]](https://github.com/ai-nuke/read-assist) ![Freeware][Freeware Icon] ![Native App][Native Icon]
