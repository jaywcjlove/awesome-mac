...
* [YT Float](https://github.com/dadhichgaurav1/yt_float) - 컴팩트 모드와 로그인 유지를 지원하는, 항상 위에 떠 있는 오픈 소스 YouTube 창. [![Open-Source Software][OSS Icon]](https://github.com/dadhichgaurav1/yt_float) ![Freeware][Freeware Icon]
