...
* [Conduck](https://conduck.com/) - 자체 호스팅 또는 본인 API 키로 쓰는 AI를 위한 네이티브 클라이언트. Mac, iPhone, iPad, Apple Watch, CarPlay에서 음성 대화 지원. [![Open-Source Software][OSS Icon]](https://github.com/GigaDuckAI/conduck) ![Freeware][Freeware Icon]
