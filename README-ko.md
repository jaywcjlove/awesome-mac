...
* [Orbly](https://github.com/lou1s19/Orbly) - Fn 키를 누른 채 말하고 놓으면 커서 위치에 텍스트가 입력된다. Whisper가 기기에서 직접 실행되며 계정과 클라우드가 필요 없다. [![Open-Source Software][OSS Icon]](https://github.com/lou1s19/Orbly) ![Freeware][Freeware Icon]
