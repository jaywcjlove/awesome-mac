...
* [Claude Desktop Usage](https://github.com/eastonsuo/claude-desktop-usage) - 메뉴 막대에서 Claude.ai의 5시간 및 주간 사용량과 초기화 시간을 확인하며, 데이터는 로그인된 Claude 데스크톱 앱 세션에서 로컬로 읽어옵니다. [![Open-Source Software][OSS Icon]](https://github.com/eastonsuo/claude-desktop-usage) ![Freeware][Freeware Icon]
