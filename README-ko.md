...
* [Clipboard Router](https://ibrolord.github.io/clipboard-router-releases/) - 검색 가능한 기록, 순차 붙여넣기 대기열, 검토 가능한 자동화, 보호된 클립을 제공하는 오픈 소스 클립보드 작업 공간입니다. [![Open-Source Software][OSS Icon]](https://github.com/ibrolord/clipboard-router) ![Freeware][Freeware Icon] ![Native App][Native Icon]
