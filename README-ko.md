...
* [Lore](https://nosleeplab.com/apps/lore) - AI 에이전트가 쓰는 마크다운 폴더를 읽고 변경 사항과 사람이 확인한 페이지를 보여 주는 리더. [![Open-Source Software][OSS Icon]](https://github.com/markksantos/lore) ![Freeware][Freeware Icon]
