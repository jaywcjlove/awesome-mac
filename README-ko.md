...
* [Ghostmark](https://nosleeplab.com/apps/ghostmark) - 이름과 오늘 날짜 같은 실시간 워터마크를 모든 디스플레이에 타일 형태로 띄우는 화면 공유·녹화용 도구. [![Open-Source Software][OSS Icon]](https://github.com/markksantos/Ghostmark) ![Freeware][Freeware Icon]
