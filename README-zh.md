...
* [Ouroboros](https://ouroboros-agent.ai/) - 开源通用 AI 智能体，具备持久身份和记忆、经审核的自我修改，以及桌面和命令行界面。 [![Open-Source Software][OSS Icon]](https://github.com/razzant/ouroboros) ![Freeware][Freeware Icon]
