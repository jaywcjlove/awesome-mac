...
* [Relic](https://relic.space/) - 本地优先的端到端加密剪贴板仓库，支持永久历史记录、设备端 AI 搜索和可选的自托管同步。 [![Open-Source Software][OSS Icon]](https://github.com/RelicSync/relic) ![Freeware][Freeware Icon]
