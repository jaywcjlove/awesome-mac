...
* [Binders](https://binders.io) - 在本机完成语音输入、会议记录和可搜索的工作记忆，并为 AI 工具提供 MCP 服务器。 [![Open-Source Software][OSS Icon]](https://github.com/binders-io/app) ![Freeware][Freeware Icon]
