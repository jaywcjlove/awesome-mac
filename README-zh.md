...
* [Higgs](https://github.com/panbanda/higgs) - 在本地运行 MLX 模型，提供 OpenAI 与 Anthropic 兼容 API、多提供商路由和仪表盘应用。 [![Open-Source Software][OSS Icon]](https://github.com/panbanda/higgs) ![Freeware][Freeware Icon]
