...
* [Devie AI Quota Tracker](https://github.com/mathdevie/devie-ai-quota-tracker) - 在一处追踪 AI 订阅额度（Claude Code、Codex、Gemini CLI、GitHub Copilot 和 Cursor）的仪表盘与 macOS 菜单栏工具，支持多账号、通知和会话计时器启动优化。 [![Open-Source Software][OSS Icon]](https://github.com/mathdevie/devie-ai-quota-tracker) ![Freeware][Freeware Icon]
