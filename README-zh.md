...
* [QdrantBar](https://github.com/fr3on/qdrantbar) - 用于监控 Qdrant 向量数据库的菜单栏应用：健康状态、集合、索引和快照。 [![Open-Source Software][OSS Icon]](https://github.com/fr3on/qdrantbar) ![Freeware][Freeware Icon]
