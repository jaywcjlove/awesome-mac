...
* [OmniWM](https://omniwm.app) - 面向运行 macOS 26 或更高版本的 Apple 芯片 Mac 的免费开源平铺式窗口管理器，提供 Niri 风格的滚动容器和 Hyprland 风格的 Dwindle BSP。[![Open-Source Software][OSS Icon]](https://github.com/BarutSRB/OmniWM) ![Freeware][Freeware Icon]
