...
* [MacPilot](https://github.com/misswell/MacPilot) - 开源菜单栏工具箱，集按应用自动退出规则、BLE 靠近解锁、窗口切换器、剪贴板历史、平滑滚动、画中画、截图贴图与录屏于一身，Swift 原生实现。 [![Open-Source Software][OSS Icon]](https://github.com/misswell/MacPilot) ![Freeware][Freeware Icon]
