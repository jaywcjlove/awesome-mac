...
* [OmniMac](https://github.com/BySergiMM/OmniMac) - 把 Dynamic Island 带到任何 Mac（有无刘海均可）的轻量菜单栏应用，另含十个实用工具：防休眠、按窗口 ⌘Tab、窗口快捷键与布局、剪贴板历史、按应用音量与均衡器、性能监控、OCR 和应用卸载清理。 [![Open-Source Software][OSS Icon]](https://github.com/BySergiMM/OmniMac) ![Freeware][Freeware Icon]
