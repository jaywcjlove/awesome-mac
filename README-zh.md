...
* [CopySight](https://copysight.guillermozubikarai.dev/en) - 开源菜单栏工具，使用设备端私密 OCR 从任意屏幕区域复制文字。 [![Open-Source Software][OSS Icon]](https://github.com/copysightapp/copysight) ![Freeware][Freeware Icon] ![Native App][Native Icon]
