...
* [qwen-audio-agent](https://github.com/QwenAudio/qwen-audio-agent) - 面向 AI 编程智能体（Claude Code、Codex、OpenCode）的全双工语音交互界面，支持本地唤醒词与随时打断。 [![Open-Source Software][OSS Icon]](https://github.com/QwenAudio/qwen-audio-agent) ![Freeware][Freeware Icon]
