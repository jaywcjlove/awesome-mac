...
* [Earnote](https://earnote.dev) - 录制讲座、会议与通话，使用 Whisper 在本机转写，并通过本地大模型生成结构化笔记。 [![Open-Source Software][OSS Icon]](https://github.com/louiskl/Earnote) ![Freeware][Freeware Icon]
