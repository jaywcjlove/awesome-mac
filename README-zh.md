...
* [Voicely](https://voicely.art) - 离线语音输入工具，可在任意应用中听写，录制通话并区分说话人，本地使用 Parakeet V3 转写音视频文件；内置供 AI 编码助手使用的 MCP 服务器。 [![Open-Source Software][OSS Icon]](https://github.com/StulkovLD/Voicely) ![Freeware][Freeware Icon]
