...
* [Codex Quota Overlay](https://github.com/cpys/codex-quota-overlay) - 在会话标题旁显示 Codex Desktop 剩余额度、重置时间和重置卡的开源悬浮层。 [![Open-Source Software][OSS Icon]](https://github.com/cpys/codex-quota-overlay) ![Freeware][Freeware Icon]
