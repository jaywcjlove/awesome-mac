...
* [OpenVoiceFlow](https://openvoiceflow.com/) - 免费开源的按键说话听写工具，使用 WhisperKit 在设备端转写，并提供可选的文本整理。 [![Open-Source Software][OSS Icon]](https://github.com/shimoverse/openvoiceflow) ![Freeware][Freeware Icon]
