...
* [Plainsay](https://plainsay.app/) - 使用 Whisper 或 Parakeet 在本地设备上转写的语音输入工具，可选择使用你自己的密钥进行文本润色。 [![Open-Source Software][OSS Icon]](https://github.com/conrader/plainsay) ![Freeware][Freeware Icon]
