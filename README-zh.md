...
* [DSH Studio](https://github.com/Moresyl/dsh-studio) - 为 DeepSeek Harness 提供一键安装、生命周期管理和内嵌网页界面的开源桌面宿主。 [![Open-Source Software][OSS Icon]](https://github.com/Moresyl/dsh-studio) ![Freeware][Freeware Icon]
