...
* [KinetAios](https://github.com/phinn/KinetAios) - 本地优先的多引擎 AI 代理仪表盘，可在一窗口并排运行 Claude Code、Codex 和内置 ReAct 引擎，共享跨引擎记忆，支持 MCP 与插件。 [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/phinn/KinetAios)
