...
* [GEOKit](https://geokit.site) - 免费开源的生成式引擎优化 (GEO) 与 AI SEO 站长工具箱，支持 llms.txt 验证、AI 爬虫管理与就绪度评分。支持 Homebrew 一键安装（`brew install gstar-byte/tap/geokit`）。 [![Open-Source Software][OSS Icon]](https://github.com/gstar-byte/geokit-cli) ![Freeware][Freeware Icon]
