...
* [Qwen Scribe](https://github.com/VladUZH/qwen-scribe) - 在 Apple Silicon 上通过 Mac GPU 运行 Qwen3-ASR 的本地文件转写与按住说话听写工具。 [![Open-Source Software][OSS Icon]](https://github.com/VladUZH/qwen-scribe) ![Freeware][Freeware Icon]
