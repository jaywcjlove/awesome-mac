...
* [Aman Disk](https://github.com/MidZai/aman_disk) - 以通俗易懂的方式显示 Mac 内置硬盘的 S.M.A.R.T. 健康状况、温度历史和性能测试。 [![Open-Source Software][OSS Icon]](https://github.com/MidZai/aman_disk) ![Freeware][Freeware Icon] ![Native App][Native Icon]
* [AltStore](https://altstore.io/) - 非越狱 iOS 设备的替代应用商店。[![Open-Source Software][OSS Icon]](https://altstore.io/#Downloads) ![Freeware][Freeware Icon]
