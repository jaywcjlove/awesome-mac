...
* [Hop](https://hop.tools) - 十六个日常小工具收在菜单栏的一块面板里：计时器、时间跟踪、防休眠、系统监控、剪贴板历史、文件转换器、窗口管理器、文字识别等。用不到的模块保持关闭，不会加载。[![Open-Source Software][OSS Icon]](https://github.com/antonyshakirov/hop) ![Freeware][Freeware Icon] ![Native App][Native Icon]
