...
* [Local MCP](https://local-mcp.com) - 将 Claude、ChatGPT、Cursor 和 VS Code 连接到邮件、日历、通讯录、iMessage、Microsoft Teams、Slack、WhatsApp、OneDrive 和本地文件，239 个工具全部在设备上运行。 ![Freeware][Freeware Icon] ![Native App][Native Icon]
