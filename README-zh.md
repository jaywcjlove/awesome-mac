...
* [Diff Anything](https://martingruner.com/projects/diffanything) - 在本地比较文本、结构化数据、文件夹、图像等内容。 [![App Store][app-store Icon]](https://apps.apple.com/us/app/diff-anything/id6795463996?mt=12)
