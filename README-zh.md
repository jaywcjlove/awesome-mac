...
* [Browser Cookie Bridge](https://cookiebridge.apoorvdarshan.com/) - 从菜单栏在浏览器和自动化工具之间传输已认证的 Chromium 会话。 [![Open-Source Software][OSS Icon]](https://github.com/apoorvdarshan/browser-cookie-bridge) ![Freeware][Freeware Icon]
