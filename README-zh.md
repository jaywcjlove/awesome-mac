...
* [QuotaBar](https://roketrp.github.io/QuotaBar/) - 本地优先的菜单栏工具，用于查看 OpenAI Codex 的 5 小时和周额度、重置倒计时与可选提醒。 [![Open-Source Software][OSS Icon]](https://github.com/RoketrP/QuotaBar) ![Freeware][Freeware Icon]
