...
* [EKO](https://www.reactivepixels.com/eko) - 面向 Navidrome、Subsonic 和本地文件的比特完美音乐播放器，让输出设备匹配每个文件的采样率，并提供 10 段均衡器、ReplayGain 和无缝播放。 [![Open-Source Software][OSS Icon]](https://github.com/reactivepixels/eko) ![Freeware][Freeware Icon]
