...
* [Tura](https://turaai.net/) - 本地优先的开源 AI 编程代理，提供 CLI、TUI、桌面和 Web 界面，并支持 OpenAI 兼容 API 与本地模型。 [![Open-Source Software][OSS Icon]](https://github.com/Tura-AI/tura) ![Freeware][Freeware Icon]
