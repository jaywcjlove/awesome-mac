...
* [CodeBurn](https://codeburn.app) - 开源菜单栏应用与命令行工具，按项目、模型和任务追踪 Claude Code、Codex、Cursor 等 40 多款 AI 编程工具的花费。 [![Open-Source Software][OSS Icon]](https://github.com/getagentseal/codeburn) ![Freeware][Freeware Icon]
