...
* [Friday](https://hellofriday.ai/) - 提供可共享工作区、MCP 工具、技能、记忆以及 cron/Webhook 自动化的 Agent 框架平台。源码可见：[friday-platform/friday-studio](https://github.com/friday-platform/friday-studio)。
