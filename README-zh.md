...
* [Human Eyes](https://github.com/neural-beat/human-eyes) - 浏览、搜索并以图谱查看你的 Claude Code 和 Codex 历史：会话、记忆笔记、技能和 MCP 服务器，数据全部保留在你的 Mac 上。 [![Open-Source Software][OSS Icon]](https://github.com/neural-beat/human-eyes) ![Freeware][Freeware Icon] ![Native App][Native Icon]
