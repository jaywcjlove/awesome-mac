...
* [NoMicSwitch](https://github.com/marks-zyz/NoMicSwitch) - 将默认音频输入锁定为内置麦克风并锁定输入音量，避免 AirPods 抢占麦克风。[![Open-Source Software][OSS Icon]](https://github.com/marks-zyz/NoMicSwitch) ![Freeware][Freeware Icon]
