...
* [Performance Monitor](https://perfmon.knhome.nl) - 轻量级菜单栏系统监视器：CPU、内存、网络、磁盘、GPU、各传感器温度、固态硬盘损耗和电池健康度。无遥测。[![Open-Source Software][OSS Icon]](https://github.com/inequitas/performancemonitor) ![Freeware][Freeware Icon]
