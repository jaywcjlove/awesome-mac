...
* [KIAgent](https://localkiagent.com) - 个人数字记忆：将你的邮件、聊天和文档索引到本地 SQLite 数据库，并通过 MCP 提供给你的 AI 助手。 [![Open-Source Software][OSS Icon]](https://github.com/edjafarov/kiagent-core) ![Freeware][Freeware Icon]
